...
import { LineChartComponent } from '../components/charts/chartjs/line/line';
import { BarChartComponent } from '../components/charts/chartjs/bar/bar';
import { PieChartComponent } from '../components/charts/chartjs/pie/pie';
import { StackBarChartComponent } from '../components/charts/chartjs/stackbar/stackbar';
import { AreaChartComponent } from '../components/charts/chartjs/area/area';
import { LineAreaComposedChartComponent } from '../components/charts/chartjs/linearecomposed/linearecomposed';
import { ScatterChartComponent } from '../components/charts/chartjs/scatter/scatter';
import { DonnutChartComponent } from '../components/charts/chartjs/donnut/donnut';
import { RadarChartComponent } from '../components/charts/chartjs/radar/radar';
import { 
  generateLineData, 
  generateBarData, 
  generatePieData,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-3xl font-bold text-gray-800">Chart.js Performance Test</h1>
            <Link
              to="/"
